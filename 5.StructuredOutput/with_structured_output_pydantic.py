...
class Review(BaseModel):
    ...
    pros: Optional[list[str]] = Field(default=None, description="Write down all the pros mentioned inside a list.")
    cons: Optional[list[str]] = Field(default=None, description="Write down all the cons mentioned inside a list.")
